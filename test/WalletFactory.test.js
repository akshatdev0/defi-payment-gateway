...
contract("WalletFactory", function (accounts) {
  ...
  it("generates correct addresses", async () => {
    ...
    generatedAddress = getCreate2TronAddress(factoryAddressHex, USER_IDENTIFIER_1, bytecode);
    ...
    generatedAddress = getCreate2TronAddress(factoryAddressHex, USER_IDENTIFIER_2, bytecode);
    ...
    generatedAddress = getCreate2TronAddress(deployerAddressHex, USER_IDENTIFIER_1, bytecode);
